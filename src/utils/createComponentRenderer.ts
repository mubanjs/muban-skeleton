...
export function renderLazyComponentTemplate(componentMap: Record<string, ComponentTemplate>, { component, components }: ComponentRendererTemplateProps): string | Array<string> {
